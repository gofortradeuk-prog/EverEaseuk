  ...
  try {
    ...
    if (stripe) {
      try {
        ...
        await stripe.invoiceItems.create({
          ...
          amount: plan.pence,
          currency: 'gbp',
          description: `EverEase UK ${plan.name} Monthly Membership - Initial Subscription (Protected by BACS Direct Debit Guarantee)`,
        });
    ...
    const responsePayload = {
      ...
      paymentMethodsAllowed: [
        'BACS Direct Debit (Protected by BACS Direct Debit Guarantee)',
